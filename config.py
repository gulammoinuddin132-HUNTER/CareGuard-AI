...
WAREHOUSE_TRACK_MAX_MISSED_FRAMES = int(os.getenv("WAREHOUSE_TRACK_MAX_MISSED_FRAMES", "20"))
WAREHOUSE_TRACK_MAX_AGE_SECONDS = float(os.getenv("WAREHOUSE_TRACK_MAX_AGE_SECONDS", "2.0"))
